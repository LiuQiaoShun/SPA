...
<div id="box-1">
    ...
    <div class="font-5">修改密码信息</div>
    <div class="font-6">
        <form action="do_update" method="post">
            <div class="form-group">
                <label for="id"></label>
                <input style="height: 35px" value="${user.id }" type="hidden" name="id" class="form-control" id="id" required="required" pattern="[0-9]{4,}" placeholder="1001">

                <label for="password">用户密码:</label>
                <input style="height: 35px" value="${user.password}" type="text" name="password" class="form-control" id="password" required="required"  placeholder="请输入密码最少6位字符:123456" pattern="\w{6,}">
            </div>
            <hr>
            <p>
            <center>
