            ...
            <tbody>
                <c:forEach items="${pageInfo.list}" var="user">
                    <tr>
                        ...
                        <td>
                            <a href="to_update?id=${user.id}" class="btn btn-warning">编辑</a>
                            <a href="deletePwd?id=${user.id}" class="btn btn-danger">删除</a>
                        </td>
                    </tr>
                </c:forEach>
           </tbody>
...
<script type="text/javascript">
    function go(page) {
        $("#pageNum").val(page)
        $("#form").attr("action","http://localhost:8080/SPA/user/password")
        $("#form").submit()
    }
</script>
</body>
