...
<div id="box-1">
    ...
    <div class="font-5">
        ...
        <table class="table table-striped table-bordered table-hover">
            <thead>
                <tr>
                    <a href="to_add" class="btn btn-warning">新增职业</a>
                </tr>
                <tr class="table-info">
                    <td>序号</td>
                    <td>职业名称</td>
            ...
            <tbody>
                <c:forEach items="${pageInfo.list}" var="user">
                    <tr>
                        ...
                        <td>
                            <a href="to_editVocation?id=${user.id}" class="btn btn-primary">编辑</a>
...
<script type="text/javascript">
    function go(page) {
        $("#pageNum").val(page)
        $("#form").attr("action","http://localhost:8080/SPA/user/action")
        $("#form").submit()
    }
</script>
</body>
