...
<div id="box-1">
    ...
    <div class="font-5">新增职业信息</div>
    <div class="font-6">
        <form action="do_add" method="post" id="container">
            <p>
                <label>职业名称：</label>
                <label>
                    <input type="text" name="vocation" placeholder="请输入您的职业名称........." style="width: 400px; height:25px;" autofocus required="required">
                </label>
            </p>
            <hr>
            <p>
