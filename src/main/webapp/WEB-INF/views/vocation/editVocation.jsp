...
<div id="box-1">
    ...
    <div class="font-5">修改职业信息</div>
    <div class="font-6">
        <form action="do_editVocation" method="post">
            <div class="form-group">
                ...
                <label for="vocation">用户职业:</label>
                <input style="height: 35px" value="${user.vocation}" type="text" name="vocation" class="form-control" id="vocation" required="required">
            </div>
            <hr>
            <p>
            <center>
